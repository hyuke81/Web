...
- **`Styled-Components`**
    ...
    - css 파일을 밖에 두지 않고, 컴포넌트 내부에 넣기 때문에, css가 전역으로 중첩되지 않도록 만들어주는 장점
    ...
    - 스타일에 props 적용하기
        - 내부적으로 props을 받을 수 있고, 그 props에 따라 스타일을 변경할 수 있음
    - 스타일 상속
        - `const 컴포넌트명 = styled.스타일컴포넌트명`스타일 넣기`...`문법으로 만들어짐
        - 기존에 있는 스타일 컴포넌트를 상속 받아 재사용 함
...
- routing
    - 네트워크에서 경로를 선택하는 프로세스
        - 다양한 주소의 요청이 들어왔을 때 각각 맞는 콘텐츠로 이동시켜주는 작업
        
        ![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/f1912130-0409-4e90-a90f-6091ae253e73/9ca71f28-0e9f-4534-9a69-173d412ac25d/image.png)
